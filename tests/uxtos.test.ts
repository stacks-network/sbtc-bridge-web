...
import { attachAllInputTransactions, fetchAddressDetails, fetchUTXOs, maxCommit, fetchFeeEstimate } from "$lib/utxos";
...
describe('suite', () => {
  ...
  it.concurrent('uxto: fetchUTXOs() returns correct transaction format for address 0 and attaches the right tx data', async () => {
    ...
    let utxoSet = await fetchUTXOs(network, addressList[0]);
    ...
    utxoSet = await attachAllInputTransactions(network, utxoSet);
    expect(utxoSet[0].tx.hex).toEqual('');
  })
  ...
  it.concurrent('uxto: fetchUTXOs() returns correct transaction format for address 1 and attaches the right tx data', async () => {
    ...
    let utxoSet = await fetchUTXOs(network, addressList[1]);
    ...
    utxoSet = await attachAllInputTransactions(network, utxoSet);
    expect(utxoSet[0].tx.hex).toEqual('');
  })
})
