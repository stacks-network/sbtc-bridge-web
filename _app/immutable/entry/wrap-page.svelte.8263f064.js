import { S as SvelteComponentDev, i as init$1, s as safe_not_equal, d as dispatch_dev, v as validate_slots, a5 as createEventDispatcher, p as element, y as text, c as space, q as claim_element, r as children, z as claim_text, l as detach_dev, f as claim_space, x as add_location, u as attr_dev, g as insert_hydration_dev, O as append_hydration_dev, a1 as set_input_value, a7 as action_destroyer, W as listen_dev, A as set_data_dev, a2 as to_number, Z as noop, Y as run_all, o as onMount, _ as src_url_equal, U as validate_store, V as component_subscribe, e as empty, B as group_outros, h as transition_out, j as check_outros, k as transition_in, C as create_component, D as claim_component, E as mount_component, F as destroy_component, G as create_slot, a8 as bubble, a9 as self, P as update_slot_base, Q as get_all_dirty_from_scope, R as get_slot_changes, a0 as globals } from "../chunks/index.605ac338.js";
import { A as commonjsGlobal, B as savePaymentRequest, a as addresses, C as CONFIG } from "../chunks/stacks_connect.b652bb6f.js";
...
import { f as fmtSatoshiToBitcoin, b as explorerBtcAddressUrl } from "../chunks/utils.121fbef1.js";
import { P as PegInTransaction, D as DebugPeginInfo } from "../chunks/DebugPeginInfo.7d325b6a.js";
import { S as SignTransaction } from "../chunks/SignTransaction.64230de4.js";
...
function create_else_block$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$3, 54, 2, 1666);
      attr_dev(div1, "class", "row text-center mt-5");
      add_location(div1, file$3, 53, 0, 1629);
    },
    m: function mount(target, anchor) {
...
function create_if_block$3(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      div0 = claim_element(div1_nodes, "DIV", { class: true });
      var div0_nodes = children(div0);
      claim_component(qrcode2.$$.fragment, div0_nodes);
      div0_nodes.forEach(detach_dev);
      div1_nodes.forEach(detach_dev);
      ...
      var span0_nodes = children(span0);
      t1 = claim_text(span0_nodes, "Amount: ");
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$3, 36, 4, 1209);
      attr_dev(div1, "class", "row text-center text-warning");
      add_location(div1, file$3, 35, 0, 1162);
      add_location(span0, file$3, 43, 6, 1419);
      attr_dev(div2, "class", "col-12");
      add_location(div2, file$3, 42, 4, 1392);
      attr_dev(div3, "class", "row text-center mt-5");
      add_location(div3, file$3, 41, 0, 1353);
      add_location(span1, file$3, 49, 4, 1577);
      attr_dev(div4, "class", "col-12");
      add_location(div4, file$3, 48, 2, 1552);
      attr_dev(div5, "class", "row text-center my-3 text-small");
      add_location(div5, file$3, 47, 0, 1504);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div1, anchor);
      append_hydration_dev(div1, div0);
      mount_component(qrcode2, div0, null);
    ...
    p: function update(ctx2, dirty) {
      ...
      1) && t2_value !== (t2_value = fmtSatoshiToBitcoin(
        /*piTx*/
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$3, 29, 2, 1036);
      attr_dev(div1, "class", "row text-center");
      add_location(div1, file$3, 28, 0, 1004);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div1, anchor);
      append_hydration_dev(div1, div0);
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  onMount(async () => {
    try {
      ...
      $$invalidate(1, errorReason = "Request already being processed with these details - change the amount to send another request.");
    }
  });
  $$self.$$.on_mount.push(function() {
  ...
  return [piTx, errorReason, paymentUri];
}
