...
import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, G as validate_store, H as component_subscribe, o as onMount, c as space, p as element, f as claim_space, q as claim_element, r as children, l as detach_dev, u as attr_dev, x as add_location, g as insert_hydration_dev, I as noop, y as text, z as claim_text, J as append_hydration_dev, K as src_url_equal, L as listen_dev, M as prevent_default, w as set_style, N as createEventDispatcher, C as create_component, D as claim_component, E as mount_component, k as transition_in, h as transition_out, F as destroy_component, O as run_all, P as onDestroy, t as tick, Q as globals, e as empty, j as check_outros, B as group_outros, R as create_slot, T as update_slot_base, U as get_all_dirty_from_scope, V as get_slot_changes } from "../chunks/index.3d25d054.js";
import { C as Ce, a, Q as Qt } from "../chunks/index.227a7d99.js";
import { l as login, s as setUpMicroStacks } from "../chunks/stacks.184b0f2c.js";
import { b as base } from "../chunks/paths.c7484e21.js";
import { i as isCoordinator } from "../chunks/sbtc_admin.a26ce8ca.js";
import { s as sbtcConfig, d as defaultSbtcConfig } from "../chunks/stores.3318b909.js";
import { g as goto } from "../chunks/navigation.436cb979.js";
...
let __tla = (async () => {
  ...
  function create_if_block_3(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(a2, file$4, 27, 1, 907);
        attr_dev(span, "class", "nav-link");
        add_location(span, file$4, 26, 1, 882);
        attr_dev(li, "class", "nav-item mb-1 s-03Bkx-y2PLke");
        add_location(li, file$4, 25, 0, 854);
      },
  ...
  function create_else_block$1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(img, file$4, 47, 126, 1886);
        attr_dev(span0, "class", "px-1");
        add_location(span0, file$4, 47, 106, 1866);
        attr_dev(a2, "href", base + "/");
        attr_dev(a2, "class", "pointer px-2");
        add_location(a2, file$4, 47, 24, 1784);
        attr_dev(span1, "class", "nav-link");
        add_location(span1, file$4, 47, 1, 1761);
      },
      m: function mount(target, anchor) {
        ...
        append_hydration_dev(a2, t);
        if (!mounted) {
          dispose = listen_dev(a2, "click", prevent_default(ctx[7]), false, true, false, false);
          mounted = true;
        }
      },
      p: noop,
  ...
  function create_if_block_2(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        attr_dev(img, "width", "40");
        attr_dev(img, "height", "auto");
        add_location(img, file$4, 45, 94, 1640);
        attr_dev(span0, "class", "px-2");
        add_location(span0, file$4, 45, 74, 1620);
        attr_dev(a2, "href", base + "/");
        add_location(a2, file$4, 45, 24, 1570);
        attr_dev(span1, "class", "nav-link");
        add_location(span1, file$4, 45, 1, 1547);
      },
      m: function mount(target, anchor) {
        insert_hydration_dev(target, span1, anchor);
        append_hydration_dev(span1, a2);
        ...
        append_hydration_dev(a2, t);
        if (!mounted) {
          dispose = listen_dev(a2, "click", prevent_default(login), false, true, false, false);
          mounted = true;
        }
      },
      p: noop,
  ...
  function create_if_block_1$1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        attr_dev(img, "width", "40");
        attr_dev(img, "height", "auto");
        add_location(img, file$4, 41, 23, 1409);
        attr_dev(span0, "class", "px-2");
        add_location(span0, file$4, 41, 3, 1389);
        attr_dev(a2, "href", base + "/");
        attr_dev(a2, "class", "pointer");
        set_style(a2, "vertical-align", "middle");
        add_location(a2, file$4, 40, 2, 1286);
        attr_dev(span1, "class", "nav-link");
        add_location(span1, file$4, 39, 1, 1260);
      },
      m: function mount(target, anchor) {
        insert_hydration_dev(target, span1, anchor);
        append_hydration_dev(span1, a2);
        ...
        append_hydration_dev(span0, img);
        if (!mounted) {
          dispose = listen_dev(a2, "click", prevent_default(ctx[4]), false, true, false, false);
          mounted = true;
        }
      },
      p: noop,
  ...
  function create_if_block$1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(a2, file$4, 34, 1, 1094);
        attr_dev(span, "class", "nav-link");
        set_style(span, "position", "relative");
        set_style(span, "top", "2px");
        add_location(span, file$4, 33, 0, 1031);
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment$4(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        attr_dev(li, "class", "nav-item mb-1 s-03Bkx-y2PLke");
        add_location(li, file$4, 31, 0, 982);
      },
      m: function mount(target, anchor) {
        if (if_block0)
  ...
  function instance$4($$self, $$props, $$invalidate) {
    ...
    component_subscribe($$self, account, (value) => $$invalidate(8, $account = value));
  ...
  function create_fragment$3(ctx) {
    ...
    const block = {
      ...
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          dispose = [
            listen_dev(a1, "click", prevent_default(ctx[2]), false, true, false, false),
            listen_dev(a2, "click", prevent_default(ctx[3]), false, true, false, false)
          ];
          mounted = true;
        }
      },
  ...
  function create_else_block(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        t3 = space();
        p2 = element("p");
        t4 = text("Currently in Beta testing!");
        this.h();
      },
      l: function claim(nodes) {
        ...
        var p2_nodes = children(p2);
        t4 = claim_text(p2_nodes, "Currently in Beta testing!");
        p2_nodes.forEach(detach_dev);
      ...
      h: function hydrate() {
        ...
        add_location(p0, file, 60, 2, 1896);
        if (!src_url_equal(img.src, img_src_value = stx_eco_wallet_off))
          attr_dev(img, "src", img_src_value);
        attr_dev(img, "alt", "Connect Wallet / Login");
        attr_dev(img, "width", "40");
        attr_dev(img, "height", "auto");
        add_location(img, file, 61, 116, 2091);
        attr_dev(span0, "class", "px-1");
        add_location(span0, file, 61, 96, 2071);
        attr_dev(a2, "href", "/");
        attr_dev(a2, "class", "pointer px-2");
        add_location(a2, file, 61, 28, 2003);
        attr_dev(span1, "class", "nav-item");
        add_location(span1, file, 61, 5, 1980);
        add_location(p1, file, 61, 2, 1977);
        attr_dev(p2, "class", "mt-5 text-warning");
        add_location(p2, file, 62, 2, 2209);
        attr_dev(div, "class", "lobby bg-dark s-7IPF32Wcq3s8");
        add_location(div, file, 59, 0, 1866);
      },
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          dispose = listen_dev(a2, "click", prevent_default(ctx[3]), false, true, false, false);
          mounted = true;
        }
      },
      p: noop,
  ...
  function create_if_block_1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(div, file, 53, 0, 1797);
      },
      m: function mount(target, anchor) {
        insert_hydration_dev(target, div, anchor);
