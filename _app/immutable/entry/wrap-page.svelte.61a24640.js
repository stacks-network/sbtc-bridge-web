...
import { F as FeeDisplay, u as utils, g as getPublicKey, s as schnorr, P as PegTransaction, p as p2wpkh, a as assert, h as hex, T as Transaction, b as secp256k1, S as Script, c as Principal, U as UTXOSelection, d as SbtcWalletDisplay, e as SignTransaction } from '../chunks/SbtcWalletDisplay.065605d5.js';
...
PegInTransaction.create = async (network, fromBtcAddress) => {
  const me = new _PegInTransaction();
  return __superGet(_PegInTransaction, _PegInTransaction, "createInternal").call(globalThis, me, network, fromBtcAddress);
};
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$1, 108, 2, 3431);
		},
		m: function mount(target, anchor) {
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "mb-4");
			add_location(div, file$1, 110, 2, 3539);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(110:2) {#if showStxAddress}",
		ctx
	});
...
function create_key_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "mb-4");
			add_location(div, file$1, 114, 2, 3685);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "key",
		source: "(114:2) {#key componentKey3}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$1, 117, 19, 3815);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$1, 121, 6, 3932);
			attr_dev(div0, "class", "col");
			add_location(div0, file$1, 120, 4, 3908);
			attr_dev(div1, "class", "row s-3u3nVvJxVO6Z");
			add_location(div1, file$1, 119, 2, 3886);
		},
		m: function mount(target, anchor) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	const updateConfig = () => {
		...
		$$invalidate(15, amountOk = conf.pegOutTransaction?.pegInData?.amount > 0);
	};
	...
	const utxoUpdated = async event => {
		...
		if (data.opCode === 'address-change') {
			try {
				$$invalidate(13, piTx = await PegInTransaction.create(network, data.bitcoinAddress));
				piTx.calculateFees();
				updateConfig();
			} catch(err) {
