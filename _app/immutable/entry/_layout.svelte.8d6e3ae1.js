...
let __tla = Promise.all([
  ...
  function create_if_block_2(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        attr_dev(a, "href", base + "/admin");
        attr_dev(a, "class", "pointer px-2");
        add_location(a, file$4, 28, 1, 908);
        attr_dev(span, "class", "nav-link");
        add_location(span, file$4, 27, 1, 883);
        attr_dev(li, "class", "nav-item mb-1 s-03Bkx-y2PLke");
        add_location(li, file$4, 26, 0, 855);
      },
  ...
  function create_else_block$1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(img, file$4, 46, 126, 1659);
        attr_dev(span0, "class", "px-1");
        add_location(span0, file$4, 46, 106, 1639);
        attr_dev(a, "href", base + "/");
        attr_dev(a, "class", "pointer px-2");
        add_location(a, file$4, 46, 24, 1557);
        attr_dev(span1, "class", "nav-link");
        add_location(span1, file$4, 46, 1, 1534);
      },
      m: function mount(target, anchor) {
        ...
        append_hydration_dev(a, t);
        if (!mounted) {
          dispose = listen_dev(a, "click", prevent_default(ctx[6]), false, true, false, false);
          mounted = true;
        }
      },
      p: noop,
  ...
  function create_if_block_1$1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        attr_dev(img, "width", "40");
        attr_dev(img, "height", "auto");
        add_location(img, file$4, 42, 23, 1422);
        attr_dev(span0, "class", "px-2");
        add_location(span0, file$4, 42, 3, 1402);
        attr_dev(a, "href", base + "/");
        attr_dev(a, "class", "pointer");
        set_style(a, "vertical-align", "middle");
        add_location(a, file$4, 41, 2, 1291);
        attr_dev(span1, "class", "nav-link");
        add_location(span1, file$4, 40, 1, 1265);
      },
      m: function mount(target, anchor) {
        insert_hydration_dev(target, span1, anchor);
        append_hydration_dev(span1, a);
        ...
        append_hydration_dev(span0, img);
        if (!mounted) {
          dispose = listen_dev(a, "click", prevent_default(ctx[5]), false, true, false, false);
          mounted = true;
        }
      },
      p: noop,
  ...
  function create_if_block$1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(a, file$4, 35, 1, 1095);
        attr_dev(span, "class", "nav-link");
        set_style(span, "position", "relative");
        set_style(span, "top", "2px");
        add_location(span, file$4, 34, 0, 1032);
      },
      m: function mount(target, anchor) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(34:0) {#if webWalletNeeded}",
      ctx
    });
    return block;
  }
  function create_fragment$4(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        attr_dev(li, "class", "nav-item mb-1 s-03Bkx-y2PLke");
        add_location(li, file$4, 32, 0, 983);
      },
      m: function mount(target, anchor) {
        if (if_block0)
  ...
  function create_else_block(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(p0, file, 67, 2, 2077);
        if (!src_url_equal(img.src, img_src_value = stx_eco_wallet_off))
          attr_dev(img, "src", img_src_value);
        attr_dev(img, "alt", "Connect Wallet / Login");
        attr_dev(img, "width", "40");
        attr_dev(img, "height", "auto");
        add_location(img, file, 68, 116, 2272);
        attr_dev(span0, "class", "px-1");
        add_location(span0, file, 68, 96, 2252);
        attr_dev(a, "href", "/");
        attr_dev(a, "class", "pointer px-2");
        add_location(a, file, 68, 28, 2184);
        attr_dev(span1, "class", "nav-item");
        add_location(span1, file, 68, 5, 2161);
        add_location(p1, file, 68, 2, 2158);
        attr_dev(p2, "class", "mt-5 text-warning");
        add_location(p2, file, 69, 2, 2390);
        attr_dev(div, "class", "lobby bg-dark s-7IPF32Wcq3s8");
        add_location(div, file, 66, 0, 2047);
      },
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          dispose = listen_dev(a, "click", prevent_default(ctx[2]), false, true, false, false);
          mounted = true;
        }
      },
      p: noop,
  ...
  function create_if_block_1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(div, file, 60, 0, 1978);
      },
      m: function mount(target, anchor) {
        insert_hydration_dev(target, div, anchor);
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(60:0) {#if $sbtcConfig && $sbtcConfig.loggedIn}",
      ctx
    });
    return block;
  }
