...
import { a as addresses, l as logUserOut, b as loginStacksJs, u as userSession } from "../chunks/stacks_connect.7f325cc2.js";
import { i as isCoordinator } from "../chunks/sbtc_admin.9e714eeb.js";
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(a3, "href", "/reclaim");
      add_location(a3, file$3, 35, 10, 1847);
      add_location(li2, file$3, 35, 6, 1843);
      ...
      add_location(li3, file$3, 28, 4, 1336);
      attr_dev(a4, "class", "");
      attr_dev(a4, "href", "/history");
      add_location(a4, file$3, 40, 50, 2049);
      attr_dev(span3, "title", "Your SBTC Transaction History");
      add_location(span3, file$3, 40, 6, 2005);
      attr_dev(span4, "class", "pointer nav-link");
      add_location(span4, file$3, 39, 5, 1967);
      attr_dev(li4, "class", "badge nav-item s-WFTADzNPIVrM");
      add_location(li4, file$3, 38, 4, 1934);
