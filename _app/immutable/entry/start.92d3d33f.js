import { o as onMount, t as tick } from "../chunks/index.605ac338.js";
import { S as SCROLL_KEY, a as SNAPSHOT_KEY, I as INDEX_KEY, g as get_base_uri, f as find_anchor, b as get_link_info, c as get_router_options, s as stores, i as is_external_url, d as scroll_state, e as base, P as PRELOAD_PRIORITIES, h as init } from "../chunks/singletons.bbdb1146.js";
...
function validator(expected) {
  ...
  function validate(module, file) {
    ...
    for (const key in module) {
      if (key[0] === "_" || set2.has(key))
        continue;
      const hint = hint_for_supported_files(key, file == null ? void 0 : file.slice(file.lastIndexOf("."))) ?? `valid exports are ${expected.join(", ")}, or anything with a '_' prefix`;
      ...
      };
      {
        try {
          ...
          if (data != null && Object.getPrototypeOf(data) !== Object.prototype) {
            throw new Error(
              `a load function related to route '${route.id}' returned ${typeof data !== "object" ? `a ${typeof data}` : data instanceof Response ? "a Response object" : Array.isArray(data) ? "an array" : "a non-plain object"}, but must return a plain object at the top level (i.e. \`return {...}\`)`
            );
          }
        } finally {
          unlock_fetch();
