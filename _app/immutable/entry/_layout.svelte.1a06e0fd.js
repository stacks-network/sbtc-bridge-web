...
import { a as addresses, l as logUserOut, s as setConfig, b as loginStacksJs, f as fetchSbtcBalance, C as CONFIG, c as fetchSbtcData, u as userSession } from "../chunks/stacks_connect.d5a9d30a.js";
import { g as goto, b as beforeNavigate } from "../chunks/navigation.7f38ddda.js";
...
import { i as isCoordinator } from "../chunks/sbtc_admin.b105fd2e.js";
import { s as sbtcConfig, d as defaultSbtcConfig } from "../chunks/stores.d1299e51.js";
import { U as UserBalance } from "../chunks/UserBalance.53fbfe22.js";
import { C as COMMS_ERROR } from "../chunks/utils.425beebd.js";
const app = "";
...
function create_else_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 90, 2, 3127);
    },
    m: function mount(target, anchor) {
...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(p0, file, 84, 6, 2727);
      if (!src_url_equal(img.src, img_src_value = stx_eco_wallet_off))
        attr_dev(img, "src", img_src_value);
      attr_dev(img, "alt", "Connect Wallet / Login");
      attr_dev(img, "width", "40");
      attr_dev(img, "height", "auto");
      add_location(img, file, 85, 120, 2923);
      attr_dev(span0, "class", "px-1");
      add_location(span0, file, 85, 100, 2903);
      attr_dev(a, "href", "/");
      attr_dev(a, "class", "pointer px-2");
      add_location(a, file, 85, 32, 2835);
      attr_dev(span1, "class", "nav-item");
      add_location(span1, file, 85, 9, 2812);
      add_location(p1, file, 85, 6, 2809);
      attr_dev(p2, "class", "mt-5 text-warning");
      add_location(p2, file, 86, 6, 3045);
      attr_dev(div, "class", "lobby bg-dark s-7IPF32Wcq3s8");
      add_location(div, file, 83, 4, 2693);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file, 77, 4, 2600);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(77:2) {#if $sbtcConfig && $sbtcConfig.loggedIn}",
    ctx
  });
  return block;
}
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 94, 4, 3275);
      attr_dev(div1, "class", "card-width");
      add_location(div1, file, 93, 2, 3246);
    },
    m: function mount(target, anchor) {
