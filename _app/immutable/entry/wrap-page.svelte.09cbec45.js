import { S as SvelteComponentDev, i as init$1, s as safe_not_equal, d as dispatch_dev, v as validate_slots, a5 as createEventDispatcher, p as element, y as text, c as space, q as claim_element, r as children, z as claim_text, l as detach_dev, f as claim_space, x as add_location, u as attr_dev, g as insert_hydration_dev, O as append_hydration_dev, a1 as set_input_value, a7 as action_destroyer, W as listen_dev, A as set_data_dev, a2 as to_number, _ as noop, Y as run_all, o as onMount, Z as src_url_equal, U as validate_store, V as component_subscribe, C as create_component, D as claim_component, E as mount_component, k as transition_in, h as transition_out, F as destroy_component, G as create_slot, e as empty, B as group_outros, j as check_outros, a8 as bubble, a9 as self, P as update_slot_base, Q as get_all_dirty_from_scope, R as get_slot_changes, a0 as globals } from "../chunks/index.d5e223f8.js";
import { A as commonjsGlobal, B as savePaymentRequest, a as addresses, C as CONFIG } from "../chunks/stacks_connect.185d0304.js";
import { s as sbtcConfig } from "../chunks/stores.3f4ae6bf.js";
import { F as FeeDisplay, P as Principal, U as UTXOSelection, S as SbtcWalletDisplay, a as SignTransactionWeb } from "../chunks/SbtcWalletDisplay.c4117a0a.js";
import { f as fmtSatoshiToBitcoin, l as explorerBtcAddressUrl } from "../chunks/utils.7d5a9605.js";
...
import { S as SignTransaction } from "../chunks/SignTransaction.fe6ce907.js";
...
function create_fragment$5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(span0, file$5, 38, 6, 1295);
      ...
      add_location(span1, file$5, 39, 6, 1330);
      attr_dev(label, "for", "transact-path");
      attr_dev(label, "class", "d-flex justify-content-between");
      add_location(label, file$5, 37, 4, 1222);
      attr_dev(input, "type", "number");
      attr_dev(input, "id", "from-address");
      attr_dev(input, "class", "form-control");
      attr_dev(input, "autocomplete", "off");
      add_location(input, file$5, 41, 4, 1634);
      attr_dev(div0, "class", "text-small");
      add_location(div0, file$5, 42, 4, 1788);
      attr_dev(div1, "class", "col-12");
      add_location(div1, file$5, 36, 2, 1197);
      attr_dev(div2, "class", "row");
      add_location(div2, file$5, 35, 0, 1177);
    },
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      claim_component(debugpegininfo.$$.fragment, div8_nodes);
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$3, 27, 2, 942);
      attr_dev(div1, "class", "row text-center");
      add_location(div1, file$3, 26, 0, 910);
      attr_dev(div2, "class", "col-12");
      add_location(div2, file$3, 33, 4, 1096);
      attr_dev(div3, "class", "row text-center text-warning");
      add_location(div3, file$3, 32, 0, 1049);
      add_location(span0, file$3, 40, 6, 1306);
      attr_dev(div4, "class", "col-12");
      add_location(div4, file$3, 39, 4, 1279);
      attr_dev(div5, "class", "row text-center mt-5");
      add_location(div5, file$3, 38, 0, 1240);
      add_location(span1, file$3, 46, 4, 1464);
      attr_dev(div6, "class", "col-12");
      add_location(div6, file$3, 45, 2, 1439);
      attr_dev(div7, "class", "row text-center my-3 text-small");
      add_location(div7, file$3, 44, 0, 1391);
      attr_dev(div8, "class", "col-12");
      add_location(div8, file$3, 50, 2, 1544);
      attr_dev(div9, "class", "row my-3 text-small");
      add_location(div9, file$3, 49, 0, 1508);
    },
    m: function mount(target, anchor) {
      ...
      mount_component(debugpegininfo, div8, null);
      current = true;
    },
    p: function update(ctx2, [dirty]) {
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  let { piTx } = $$props;
  const peginRequest = piTx == null ? void 0 : piTx.buildOpDropTransaction();
  const paymentUri = () => {
  ...
  return [piTx, peginRequest, paymentUri];
}
...
function create_if_block_1$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(button, file$2, 21, 33, 501);
      attr_dev(div, "class", "text-center");
      add_location(div, file$2, 21, 8, 476);
    },
    m: function mount(target, anchor) {
...
function instance$2($$self, $$props, $$invalidate) {
  ...
  return [showModal, showClose, closeModal, $$scope, slots, click_handler];
}
...
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file$1, 144, 2, 5418);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(143:0) <Modal {showModal} showClose={true} on:click={closeModal} on:close_modal={closeModal}>",
    ctx
  });
  return block;
}
function create_title_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file$1, 143, 2, 5391);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
    },
...
function create_if_block$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "mb-4");
      add_location(div, file$1, 148, 2, 5495);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
...
function create_if_block_4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "mb-4");
      add_location(div, file$1, 150, 2, 5603);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(150:2) {#if showStxAddress}",
    ctx
  });
  return block;
}
...
function create_key_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(div, "class", "mb-4");
      add_location(div, file$1, 154, 2, 5749);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "key",
    source: "(154:2) {#key componentKey3}",
    ctx
  });
  return block;
}
function create_if_block_2$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file$1, 157, 19, 5879);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
...
function create_if_block_1$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(button, file$1, 161, 6, 6002);
      attr_dev(div0, "class", "col");
      add_location(div0, file$1, 160, 4, 5978);
      attr_dev(div1, "class", "row");
      add_location(div1, file$1, 159, 2, 5956);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div1, anchor);
      append_hydration_dev(div1, div0);
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 31, 30, 1369);
      attr_dev(h1, "class", "text-info s-RlVVnrAOzilK");
      add_location(h1, file, 31, 3, 1342);
      attr_dev(h2, "class", "mb-3");
      add_location(h2, file, 32, 3, 1416);
      attr_dev(div0, "class", "my-3 d-flex justify-content-between text-white");
      add_location(div0, file, 33, 3, 1453);
      add_location(div1, file, 38, 5, 1636);
      attr_dev(div2, "class", "card border p-4");
      add_location(div2, file, 37, 4, 1601);
      attr_dev(div3, "class", "d-flex justify-content-center");
      add_location(div3, file, 36, 3, 1553);
      attr_dev(div4, "class", "card-width");
      add_location(div4, file, 30, 2, 1314);
      attr_dev(div5, "class", "my-4 p-4");
      add_location(div5, file, 29, 1, 1289);
      attr_dev(section, "class", "bg-dark s-RlVVnrAOzilK");
      add_location(section, file, 28, 0, 1262);
    },
    m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  const openSigView = () => {
    ...
    $$invalidate(1, sigData = {
      ...
      opReturnTx: piTx == null ? void 0 : piTx.buildOpReturnTransaction(),
