...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$1, 61, 4, 2001);
			attr_dev(div1, "class", "col-3");
			add_location(div1, file$1, 64, 4, 2061);
			attr_dev(div2, "class", "col-3");
			add_location(div2, file$1, 67, 4, 2137);
			attr_dev(div3, "class", "col-2");
			add_location(div3, file$1, 70, 4, 2213);
			attr_dev(div4, "class", "col-3");
			add_location(div4, file$1, 73, 4, 2279);
			attr_dev(div5, "class", "row tab-row my-3 s-ZVuZMT2fvPG2");
			add_location(div5, file$1, 60, 2, 1966);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*events*/ 1 && t0_value !== (t0_value = /*item*/ ctx[13].txData.type + "")) set_data_dev(t0, t0_value);
			if (dirty & /*events*/ 1 && t2_value !== (t2_value = truncate(/*item*/ ctx[13].txData.stxAddress) + "")) set_data_dev(t2, t2_value);
			if (dirty & /*events*/ 1 && t4_value !== (t4_value = truncate(/*item*/ ctx[13].txData.sbtcWallet) + "")) set_data_dev(t4, t4_value);
			if (dirty & /*events*/ 1 && t6_value !== (t6_value = /*item*/ ctx[13].txData.amountSats + "")) set_data_dev(t6, t6_value);
			if (dirty & /*events*/ 1 && t8_value !== (t8_value = truncate(/*item*/ ctx[13].data.value) + "")) set_data_dev(t8, t8_value);
		},
		d: function destroy(detaching) {
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$1, 33, 4, 862);
			attr_dev(a0, "href", "/");
			attr_dev(a0, "class", "pointer text-info");
			add_location(a0, file$1, 34, 4, 932);
			attr_dev(div0, "class", "d-flex justify-content-between");
			add_location(div0, file$1, 32, 2, 813);
			attr_dev(div1, "class", "row");
			add_location(div1, file$1, 31, 0, 793);
			attr_dev(a1, "href", "/");
			add_location(a1, file$1, 41, 35, 1209);
			attr_dev(div2, "class", "filter pointer ");
			add_location(div2, file$1, 41, 6, 1180);
			attr_dev(div3, "class", "col-1");
			add_location(div3, file$1, 40, 4, 1154);
			attr_dev(a2, "href", "/");
			add_location(a2, file$1, 44, 34, 1354);
			attr_dev(div4, "class", "filter pointer");
			add_location(div4, file$1, 44, 6, 1326);
			attr_dev(div5, "class", "col-3");
			add_location(div5, file$1, 43, 4, 1300);
			attr_dev(a3, "href", "/");
			add_location(a3, file$1, 47, 34, 1498);
			attr_dev(div6, "class", "filter pointer");
			add_location(div6, file$1, 47, 6, 1470);
			attr_dev(div7, "class", "col-3");
			add_location(div7, file$1, 46, 4, 1444);
			attr_dev(a4, "href", "/");
			add_location(a4, file$1, 50, 34, 1648);
			attr_dev(div8, "class", "filter pointer");
			add_location(div8, file$1, 50, 6, 1620);
			attr_dev(div9, "class", "col-2");
			add_location(div9, file$1, 49, 4, 1594);
			attr_dev(a5, "href", "/");
			add_location(a5, file$1, 53, 34, 1793);
			attr_dev(div10, "class", "filter pointer");
			add_location(div10, file$1, 53, 6, 1765);
			attr_dev(div11, "class", "col-3");
			add_location(div11, file$1, 52, 4, 1739);
			attr_dev(div12, "class", "row");
			add_location(div12, file$1, 39, 2, 1132);
			attr_dev(div13, "class", "text-white");
			add_location(div13, file$1, 38, 0, 1105);
		},
		m: function mount(target, anchor) {
...
*/
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<SbtcContractTransactions> was created with unknown prop '${key}'`);
	});
