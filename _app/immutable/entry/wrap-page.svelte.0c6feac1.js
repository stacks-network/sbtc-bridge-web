...
import { F as FeeDisplay, u as utils, g as getPublicKey, s as schnorr, P as PegTransaction, a as assert, b as Principal, U as UTXOSelection, c as SbtcWalletDisplay, d as SignTransaction } from '../chunks/SbtcWalletDisplay.e2bcb2dc.js';
import { T as TEST_NETWORK, N as NETWORK, p as p2wpkh, h as hex, b as Transaction, s as secp256k1, S as Script } from '../chunks/utils.7513f4f0.js';
import { b as fetchUtxoSet, c as fetchCurrentFeeRates } from '../chunks/bridge_api.2c2497c7.js';
import { a } from '../chunks/index.227a7d99.js';
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$1, 113, 2, 3726);
		},
		m: function mount(target, anchor) {
...
function create_if_block_4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "mb-4");
			add_location(div, file$1, 115, 2, 3834);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(115:2) {#if showStxAddress}",
		ctx
	});
...
function create_key_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "mb-4");
			add_location(div, file$1, 119, 2, 3980);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "key",
		source: "(119:2) {#key componentKey3}",
		ctx
	});
...
function create_if_block_2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$1, 122, 19, 4110);
		},
		m: function mount(target, anchor) {
			insert_hydration_dev(target, div, anchor);
...
function create_if_block_1$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$1, 126, 6, 4227);
			attr_dev(div0, "class", "col");
			add_location(div0, file$1, 125, 4, 4203);
			attr_dev(div1, "class", "row s-3u3nVvJxVO6Z");
			add_location(div1, file$1, 124, 2, 4181);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(34:6) {#if view === 'build_tx_view'}",
		ctx
	});
