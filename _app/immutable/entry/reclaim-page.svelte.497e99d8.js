...
import { a as addresses, k as hexToBytes, m as sendRawTxDirectMempool, n as utils, q as getPublicKey, r as schnorr, v as fetchUtxoSet, w as fetchTransaction, x as fetchCurrentFeeRates, y as decodeStacksAddress, C as CONFIG } from "../chunks/stacks_connect.d5a9d30a.js";
import { s as sbtcConfig } from "../chunks/stores.d1299e51.js";
import { D as DebugPeginInfo, P as PegInTransaction } from "../chunks/DebugPeginInfo.3827c20f.js";
import { C as CopyClipboard, o as openPsbtRequestPopup, a as assert, c as concatByteArrays, S as SignTransaction } from "../chunks/SignTransaction.f460d339.js";
import { c as base64, h as hex, d as btc, T as Transaction, g as TEST_NETWORK, N as NETWORK, p as p2wpkh, s as secp256k1, R as RawTx, M as MAGIC_BYTES_TESTNET, i as MAGIC_BYTES_MAINNET, P as PEGIN_OPCODE, C as COMMS_ERROR, t as truncate, a as explorerBtcTxUrl, e as explorerTxUrl } from "../chunks/utils.425beebd.js";
import { g as goto } from "../chunks/navigation.7f38ddda.js";
...
function create_if_block$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(a, "href", "/");
      add_location(a, file$1, 146, 34, 5237);
      attr_dev(div0, "class", "col-12");
      add_location(div0, file$1, 146, 4, 5207);
      attr_dev(div1, "class", "row");
      add_location(div1, file$1, 145, 2, 5185);
    },
...
function create_fragment$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$1, 116, 0, 3825);
      add_location(h2, file$1, 120, 4, 3927);
      attr_dev(div1, "class", "d-flex justify-content-between");
      add_location(div1, file$1, 119, 2, 3878);
      ...
      add_location(span, file$1, 126, 10, 4101);
      attr_dev(a0, "class", "dropdown-item");
      attr_dev(a0, "href", "/");
      add_location(a0, file$1, 130, 16, 4389);
      add_location(li0, file$1, 130, 12, 4385);
      attr_dev(a1, "class", "dropdown-item");
      attr_dev(a1, "href", "/");
      add_location(a1, file$1, 131, 16, 4524);
      add_location(li1, file$1, 131, 12, 4520);
      attr_dev(a2, "class", "dropdown-item");
      attr_dev(a2, "href", "/");
      add_location(a2, file$1, 132, 16, 4663);
      add_location(li2, file$1, 132, 12, 4659);
      attr_dev(a3, "class", "dropdown-item");
      attr_dev(a3, "href", "/");
      add_location(a3, file$1, 133, 16, 4800);
      add_location(li3, file$1, 133, 12, 4796);
      attr_dev(ul0, "class", "dropdown-menu dropdown-menu-start");
      attr_dev(ul0, "aria-labelledby", "navbarDropdown");
      add_location(ul0, file$1, 129, 10, 4293);
      attr_dev(li4, "class", "nav-item dropdown");
      add_location(li4, file$1, 125, 8, 4060);
      attr_dev(ul1, "class", "navbar-nav");
      add_location(ul1, file$1, 124, 6, 4028);
      add_location(div2, file$1, 123, 4, 4016);
      attr_dev(div3, "class", "my-3 d-flex justify-content-start");
      add_location(div3, file$1, 122, 2, 3964);
      attr_dev(div4, "class", "col-12");
      add_location(div4, file$1, 140, 4, 5003);
      attr_dev(textarea, "rows", "8");
      set_style(textarea, "width", "100%");
      set_style(textarea, "padding", "10px");
      textarea.value = /*currentTx*/
      ctx[1];
      add_location(textarea, file$1, 141, 24, 5073);
      attr_dev(div5, "class", "col-12");
      add_location(div5, file$1, 141, 4, 5053);
      attr_dev(div6, "class", "row");
      add_location(div6, file$1, 139, 2, 4981);
      set_style(input, "visibility", "hidden");
      add_location(input, file$1, 152, 2, 5398);
      attr_dev(section, "class", "mb-3");
      add_location(section, file$1, 118, 0, 3853);
    },
    m: function mount(target, anchor) {
