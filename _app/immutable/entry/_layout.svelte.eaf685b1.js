...
function create_else_block$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$4, 80, 127, 3511);
      attr_dev(span0, "class", "px-1");
      add_location(span0, file$4, 80, 107, 3491);
      attr_dev(a, "href", "/");
      attr_dev(a, "class", "pointer px-2");
      add_location(a, file$4, 80, 31, 3415);
      attr_dev(span1, "class", "dropdown-item");
      add_location(span1, file$4, 80, 3, 3387);
    },
    m: function mount(target, anchor) {
...
function create_if_block_1$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(img, "width", "40");
      attr_dev(img, "height", "auto");
      add_location(img, file$4, 76, 25, 3256);
      attr_dev(span0, "class", "px-2");
      add_location(span0, file$4, 76, 5, 3236);
      attr_dev(a, "href", "/");
      attr_dev(a, "class", "pointer");
      set_style(a, "vertical-align", "middle");
      add_location(a, file$4, 75, 4, 3129);
      attr_dev(span1, "class", "dropdown-item");
      add_location(span1, file$4, 74, 3, 3096);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, span1, anchor);
      append_hydration_dev(span1, a);
...
function create_if_block$1(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(68:2) {#if webWalletNeeded}",
    ctx
  });
  return block;
}
function create_fragment$4(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      t8 = claim_text(a2_nodes, "Settings");
    ...
    h: function hydrate() {
      ...
      add_location(a2, file$4, 64, 51, 2578);
      attr_dev(span2, "class", "dropdown-item");
      add_location(span2, file$4, 64, 23, 2550);
      ...
      add_location(li4, file$4, 66, 2, 2793);
...
function create_fragment$3(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      t11 = claim_text(a3_nodes, "Reclaim BTC");
    ...
    h: function hydrate() {
      ...
      add_location(a4, file$3, 40, 50, 2045);
      attr_dev(span3, "title", "Your sBTC Transaction History");
      add_location(span3, file$3, 40, 6, 2001);
      attr_dev(span4, "class", "pointer nav-link");
      add_location(span4, file$3, 39, 5, 1963);
      attr_dev(li4, "class", "badge nav-item s-WFTADzNPIVrM");
      add_location(li4, file$3, 38, 4, 1930);
