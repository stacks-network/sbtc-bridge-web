...
import { s as sbtcConfig } from "./stores.c4e5deb1.js";
import { b as explorerBtcAddressUrl, h as hex, c as base64 } from "./utils.cf20df3f.js";
...
function create_if_block_5$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[2];
      add_location(textarea, file$5, 74, 8, 2980);
    },
    m: function mount(target, anchor) {
...
function create_if_block$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(h40, file$5, 52, 8, 1979);
      attr_dev(section0, "class", "mb-4");
      add_location(section0, file$5, 51, 6, 1948);
      add_location(h41, file$5, 61, 6, 2337);
      add_location(section1, file$5, 60, 4, 2321);
    },
    m: function mount(target, anchor) {
...
function create_each_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file$5, 55, 41, 2176);
      attr_dev(div0, "class", "col-10");
      add_location(div0, file$5, 55, 8, 2143);
      attr_dev(div1, "class", "col-2");
      add_location(div1, file$5, 56, 8, 2234);
      attr_dev(div2, "class", "info-panel text-small mx-1 row bg-light my-1 py-1 text-dark");
      add_location(div2, file$5, 54, 6, 2061);
    },
    m: function mount(target, anchor) {
...
function create_if_block_3$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(span, "class", "text-dark");
      add_location(span, file$5, 66, 30, 2651);
    },
    m: function mount(target, anchor) {
...
function create_if_block_2$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(span, "class", "text-dark");
      add_location(span, file$5, 67, 29, 2733);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, span, anchor);
      append_hydration_dev(span, t);
...
function create_if_block_1$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(span, "class", "text-dark");
      add_location(span, file$5, 69, 46, 2846);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, span, anchor);
      append_hydration_dev(span, t);
...
function create_each_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$5, 64, 8, 2509);
      attr_dev(div1, "class", "col-8");
      add_location(div1, file$5, 65, 8, 2601);
      attr_dev(div2, "class", "col-2");
      add_location(div2, file$5, 69, 8, 2808);
      attr_dev(div3, "class", "info-panel text-small mx-1 row bg-light my-1 py-1 text-danger");
      add_location(div3, file$5, 63, 6, 2425);
    },
    m: function mount(target, anchor) {
...
function create_fragment$5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div9, file$5, 31, 4, 995);
      attr_dev(div10, "class", "col-8");
      add_location(div10, file$5, 32, 4, 1039);
      attr_dev(div11, "class", "row");
      add_location(div11, file$5, 30, 2, 973);
      attr_dev(div12, "class", "col-4");
      add_location(div12, file$5, 35, 4, 1128);
      attr_dev(div13, "class", "col-8");
      add_location(div13, file$5, 36, 4, 1164);
      attr_dev(div14, "class", "row");
      add_location(div14, file$5, 34, 2, 1106);
      attr_dev(div15, "class", "col-4");
      add_location(div15, file$5, 39, 4, 1246);
      attr_dev(a0, "class", "text-info");
      attr_dev(a0, "href", "/");
      add_location(a0, file$5, 42, 27, 1351);
      attr_dev(span0, "class", "mx-1");
      add_location(span0, file$5, 42, 8, 1332);
      attr_dev(a1, "class", "text-info");
      attr_dev(a1, "href", "/");
      add_location(a1, file$5, 43, 32, 1554);
      attr_dev(span1, "class", "mx-1 me-4");
      add_location(span1, file$5, 43, 8, 1530);
      attr_dev(a2, "class", "text-info");
      attr_dev(a2, "href", "/");
      add_location(a2, file$5, 44, 14, 1742);
      add_location(span2, file$5, 44, 8, 1736);
      attr_dev(div16, "class", "");
      add_location(div16, file$5, 41, 6, 1309);
      attr_dev(div17, "class", "col-8");
      add_location(div17, file$5, 40, 4, 1283);
      attr_dev(div18, "class", "row");
      add_location(div18, file$5, 38, 2, 1224);
      attr_dev(div19, "class", "col-12");
      add_location(div19, file$5, 49, 4, 1902);
      attr_dev(div20, "class", "row");
      add_location(div20, file$5, 48, 2, 1880);
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 102, 5, 3504);
      attr_dev(li, "class", "nav-item dropdown");
      add_location(li, file, 101, 4, 3468);
      attr_dev(ul, "class", "navbar-nav");
      add_location(ul, file, 100, 3, 3440);
      add_location(div0, file, 99, 4, 3431);
      attr_dev(div1, "class", "my-3 d-flex justify-content-start");
      add_location(div1, file, 98, 2, 3379);
    },
    m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(div0, file, 112, 4, 3822);
      attr_dev(div1, "class", "my-3 text-warning");
      add_location(div1, file, 111, 2, 3786);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div1, anchor);
      append_hydration_dev(div1, div0);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(111:2) {#if $sbtcConfig.userSettings.debugMode && errorReason}",
    ctx
  });
  return block;
}
...
function create_fragment(ctx) {
  ...
  let if_block2 = (
    /*$sbtcConfig*/
    ctx[7].userSettings.debugMode && /*errorReason*/
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 72, 0, 2395);
      add_location(h2, file, 75, 4, 2496);
      attr_dev(div1, "class", "d-flex justify-content-between");
      add_location(div1, file, 74, 2, 2447);
      attr_dev(section0, "class", "mb-3");
      add_location(section0, file, 73, 0, 2422);
      attr_dev(span, "class", "nav-link dropdown-toggle ");
      attr_dev(span, "id", "navbarDropdown");
      attr_dev(span, "role", "button");
      attr_dev(span, "data-bs-toggle", "dropdown");
      attr_dev(span, "aria-expanded", "false");
      add_location(span, file, 86, 5, 2793);
      attr_dev(a0, "class", "dropdown-item");
      attr_dev(a0, "href", "/");
      add_location(a0, file, 90, 10, 3076);
      add_location(li0, file, 90, 6, 3072);
      attr_dev(a1, "class", "dropdown-item");
      attr_dev(a1, "href", "/");
      add_location(a1, file, 91, 10, 3203);
      add_location(li1, file, 91, 6, 3199);
      attr_dev(ul0, "class", "dropdown-menu dropdown-menu-start");
      attr_dev(ul0, "aria-labelledby", "navbarDropdown");
      add_location(ul0, file, 89, 5, 2986);
      attr_dev(li2, "class", "nav-item dropdown");
      add_location(li2, file, 85, 4, 2757);
      attr_dev(ul1, "class", "navbar-nav");
      add_location(ul1, file, 84, 3, 2729);
      add_location(div2, file, 83, 4, 2720);
      attr_dev(div3, "class", "my-3 d-flex justify-content-start");
      add_location(div3, file, 82, 2, 2668);
      set_style(input, "visibility", "hidden");
      add_location(input, file, 115, 2, 3866);
      add_location(section1, file, 81, 0, 2656);
    },
    m: function mount(target, anchor) {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      if (
        /*$sbtcConfig*/
        ctx2[7].userSettings.debugMode && /*errorReason*/
        ctx2[2]
      ) {
        if (if_block2) {
          if_block2.p(ctx2, dirty);
  ...
  const updateWallet = async (newWallet) => {
    ...
    if ($sbtcConfig.pegIn) {
      try {
        ...
        $$invalidate(2, errorReason = "Unable to save pegin data.");
      }
    }
  };
  const updateTransaction = () => {
