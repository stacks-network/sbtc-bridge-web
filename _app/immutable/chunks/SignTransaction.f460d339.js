...
import { b as explorerBtcAddressUrl, h as hex, c as base64 } from "./utils.425beebd.js";
...
function create_if_block_5$1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      ctx[2];
      add_location(textarea, file$5, 74, 8, 2982);
    },
    m: function mount(target, anchor) {
...
function create_if_block$4(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(h40, file$5, 52, 8, 1981);
      attr_dev(section0, "class", "mb-4");
      add_location(section0, file$5, 51, 6, 1950);
      add_location(h41, file$5, 61, 6, 2339);
      add_location(section1, file$5, 60, 4, 2323);
    },
    m: function mount(target, anchor) {
...
function create_each_block_1(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(span, file$5, 55, 41, 2178);
      attr_dev(div0, "class", "col-10");
      add_location(div0, file$5, 55, 8, 2145);
      attr_dev(div1, "class", "col-2");
      add_location(div1, file$5, 56, 8, 2236);
      attr_dev(div2, "class", "info-panel text-small mx-1 row bg-light my-1 py-1 text-dark");
      add_location(div2, file$5, 54, 6, 2063);
    },
    m: function mount(target, anchor) {
...
function create_if_block_3$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(span, "class", "text-dark");
      add_location(span, file$5, 66, 30, 2653);
    },
    m: function mount(target, anchor) {
...
function create_if_block_2$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(span, "class", "text-dark");
      add_location(span, file$5, 67, 29, 2735);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, span, anchor);
      append_hydration_dev(span, t);
...
function create_if_block_1$2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(span, "class", "text-dark");
      add_location(span, file$5, 69, 46, 2848);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, span, anchor);
      append_hydration_dev(span, t);
...
function create_each_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$5, 64, 8, 2511);
      attr_dev(div1, "class", "col-8");
      add_location(div1, file$5, 65, 8, 2603);
      attr_dev(div2, "class", "col-2");
      add_location(div2, file$5, 69, 8, 2810);
      attr_dev(div3, "class", "info-panel text-small mx-1 row bg-light my-1 py-1 text-danger");
      add_location(div3, file$5, 63, 6, 2427);
    },
    m: function mount(target, anchor) {
...
function create_fragment$5(ctx) {
  ...
  let t10_value = (
    /*webWallet*/
    ctx[6] ? "Stacks Web Wallet" : "Other Wallet"
  );
  let t10;
  let t11;
  let div11;
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file$5, 19, 4, 587);
      attr_dev(div1, "class", "col-8");
      add_location(div1, file$5, 20, 4, 624);
      attr_dev(div2, "class", "row");
      add_location(div2, file$5, 18, 2, 565);
      attr_dev(div3, "class", "col-4");
      add_location(div3, file$5, 23, 4, 736);
      attr_dev(div4, "class", "col-8");
      add_location(div4, file$5, 24, 4, 770);
      attr_dev(div5, "class", "row");
      add_location(div5, file$5, 22, 2, 714);
      attr_dev(div6, "class", "col-4");
      add_location(div6, file$5, 27, 4, 850);
      attr_dev(div7, "class", "col-8");
      add_location(div7, file$5, 28, 4, 886);
      attr_dev(div8, "class", "row");
      add_location(div8, file$5, 26, 2, 828);
      attr_dev(div9, "class", "col-4");
      add_location(div9, file$5, 31, 4, 997);
      attr_dev(div10, "class", "col-8");
      add_location(div10, file$5, 32, 4, 1041);
      attr_dev(div11, "class", "row");
      add_location(div11, file$5, 30, 2, 975);
      attr_dev(div12, "class", "col-4");
      add_location(div12, file$5, 35, 4, 1130);
      attr_dev(div13, "class", "col-8");
      add_location(div13, file$5, 36, 4, 1166);
      attr_dev(div14, "class", "row");
      add_location(div14, file$5, 34, 2, 1108);
      attr_dev(div15, "class", "col-4");
      add_location(div15, file$5, 39, 4, 1248);
      attr_dev(a0, "class", "text-info");
      attr_dev(a0, "href", "/");
      add_location(a0, file$5, 42, 27, 1353);
      attr_dev(span0, "class", "mx-1");
      add_location(span0, file$5, 42, 8, 1334);
      attr_dev(a1, "class", "text-info");
      attr_dev(a1, "href", "/");
      add_location(a1, file$5, 43, 32, 1556);
      attr_dev(span1, "class", "mx-1 me-4");
      add_location(span1, file$5, 43, 8, 1532);
      attr_dev(a2, "class", "text-info");
      attr_dev(a2, "href", "/");
      add_location(a2, file$5, 44, 14, 1744);
      add_location(span2, file$5, 44, 8, 1738);
      attr_dev(div16, "class", "");
      add_location(div16, file$5, 41, 6, 1311);
      attr_dev(div17, "class", "col-8");
      add_location(div17, file$5, 40, 4, 1285);
      attr_dev(div18, "class", "row");
      add_location(div18, file$5, 38, 2, 1226);
      attr_dev(div19, "class", "col-12");
      add_location(div19, file$5, 49, 4, 1904);
      attr_dev(div20, "class", "row");
      add_location(div20, file$5, 48, 2, 1882);
      attr_dev(section, "class", "");
      add_location(section, file$5, 16, 0, 543);
    },
    m: function mount(target, anchor) {
...
function instance$5($$self, $$props, $$invalidate) {
  ...
  $$self.$$.on_mount.push(function() {
    if (piTx === void 0 && !("piTx" in $$props || $$self.$$.bound[$$self.$$.props["piTx"]])) {
      console.warn("<PegInfo> was created without expected prop 'piTx'");
    }
  ...
  const writable_props = ["piTx", "sigData", "currentTx"];
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot")
...
class PegInfo extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance$5, create_fragment$5, safe_not_equal, { piTx: 0, sigData: 1, currentTx: 2 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "PegInfo",
      options,
...
function create_else_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 114, 2, 3888);
      attr_dev(div1, "class", "row text-center my-5");
      add_location(div1, file, 113, 0, 3851);
    },
    m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      ...
      var span_nodes = children(span);
      t0 = claim_text(span_nodes, "1. Select Wallet: ");
      if (if_block0)
      ...
      var a0_nodes = children(a0);
      t2 = claim_text(a0_nodes, "Bitcoin Core");
      a0_nodes.forEach(detach_dev);
      ...
      var a1_nodes = children(a1);
      t4 = claim_text(a1_nodes, "Electrum");
      a1_nodes.forEach(detach_dev);
    ...
    h: function hydrate() {
      ...
      add_location(span, file, 87, 8, 2885);
      attr_dev(a0, "class", "dropdown-item");
      attr_dev(a0, "href", "/");
      add_location(a0, file, 91, 14, 3182);
      add_location(li0, file, 91, 10, 3178);
      attr_dev(a1, "class", "dropdown-item");
      attr_dev(a1, "href", "/");
      add_location(a1, file, 92, 14, 3313);
      add_location(li1, file, 92, 10, 3309);
      attr_dev(ul0, "class", "dropdown-menu dropdown-menu-start");
      attr_dev(ul0, "aria-labelledby", "navbarDropdown");
      add_location(ul0, file, 90, 8, 3088);
      attr_dev(li2, "class", "nav-item dropdown");
      add_location(li2, file, 86, 6, 2846);
      attr_dev(ul1, "class", "navbar-nav");
      add_location(ul1, file, 85, 4, 2816);
      add_location(div0, file, 84, 2, 2806);
      attr_dev(div1, "class", "my-3 d-flex justify-content-start");
      add_location(div1, file, 83, 0, 2756);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div1, anchor);
      append_hydration_dev(div1, div0);
...
function create_if_block_2(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      li = element("li");
      span = element("span");
      t = text("2. Follow the Instructions Below");
      this.h();
    },
    l: function claim(nodes) {
      div1 = claim_element(nodes, "DIV", { class: true });
      ...
      var span_nodes = children(span);
      t = claim_text(span_nodes, "2. Follow the Instructions Below");
      span_nodes.forEach(detach_dev);
    ...
    h: function hydrate() {
      ...
      attr_dev(span, "data-bs-toggle", "dropdown");
      attr_dev(span, "aria-expanded", "false");
      add_location(span, file, 103, 8, 3616);
      attr_dev(li, "class", "nav-item dropdown");
      add_location(li, file, 102, 6, 3577);
      attr_dev(ul, "class", "navbar-nav");
      add_location(ul, file, 101, 4, 3547);
      add_location(div0, file, 100, 2, 3537);
      attr_dev(div1, "class", "my-3 d-flex justify-content-start");
      add_location(div1, file, 99, 0, 3487);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div1, anchor);
      append_hydration_dev(div1, div0);
...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div0, file, 72, 0, 2464);
      add_location(h2, file, 75, 4, 2565);
      attr_dev(div1, "class", "d-flex justify-content-between");
      add_location(div1, file, 74, 2, 2516);
      attr_dev(section0, "class", "mb-3");
      add_location(section0, file, 73, 0, 2491);
      set_style(input, "visibility", "hidden");
      add_location(input, file, 118, 0, 3961);
      add_location(section1, file, 80, 0, 2702);
    },
    m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  let currentTx;
  const setCurrent = () => {
    const psbt = piTx == null ? void 0 : piTx.buildOpReturnTransaction().toPSBT(2);
    wallet === "Bitcoin Core" ? $$invalidate(5, currentTx = base64.encode(psbt)) : $$invalidate(5, currentTx = hex.encode(psbt));
  };
  const updateWallet = async (newWallet) => {
    ...
    if ($sbtcConfig.pegIn) {
      try {
        ...
        $$invalidate(2, errorReason = "Request already being processed with these details - change the amount to send another request.");
      }
    }
  };
  const updateTransaction = () => {
  ...
  onMount(async () => {
    ...
    $$invalidate(5, currentTx = hex.encode(piTx == null ? void 0 : piTx.buildOpReturnTransaction().toPSBT(2)));
  });
  $$self.$$.on_mount.push(function() {
    if (piTx === void 0 && !("piTx" in $$props || $$self.$$.bound[$$self.$$.props["piTx"]])) {
      console.warn("<SignTransaction> was created without expected prop 'piTx'");
    }
  });
  ...
  $$self.$inject_state = ($$props2) => {
    if ("piTx" in $$props2)
      $$invalidate(0, piTx = $$props2.piTx);
    if ("wallet" in $$props2)
      $$invalidate(1, wallet = $$props2.wallet);
    if ("errorReason" in $$props2)
      $$invalidate(2, errorReason = $$props2.errorReason);
    if ("sigData" in $$props2)
      $$invalidate(3, sigData = $$props2.sigData);
    if ("copied" in $$props2)
...
class SignTransaction extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance, create_fragment, safe_not_equal, { piTx: 0 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
