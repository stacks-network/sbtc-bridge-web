...
const utils$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  wrapConstructor: wrapConstructor$2,
...
const sha224 = wrapConstructor$2(() => new SHA224$2());
const sha256$4 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  sha224,
  sha256: sha256$3
}, Symbol.toStringTag, { value: "Module" }));
const require$$0$1 = /* @__PURE__ */ getAugmentedNamespace(sha256$4);
...
async function savePaymentRequest(peginRequest) {
...
async function fetchMyWrapTransactions(stxAddress) {
...
async function fetchUtxoSet(address2) {
  const path = addNetSelector(CONFIG.VITE_BRIDGE_API + "/btc/wallet/address/" + address2 + "/utxos?verbose=true");
  const response = await fetch(path);
  if (response.status !== 200) {
    throw new Error("Bitcoin address not known - is the network correct?");
  }
...
const hmac$3 = (hash2, key, message) => new HMAC$2(hash2, key).update(message).digest();
hmac$3.create = (hash2, key) => new HMAC$2(hash2, key);
...
let SHA2$1 = class SHA22 extends Hash$1 {
  constructor(blockLen, outputLen, padOffset, isLE2) {
    super();
    this.blockLen = blockLen;
    this.outputLen = outputLen;
...
let SHA224$1 = class SHA2242 extends SHA256$1 {
  constructor() {
    super();
    this.A = 3238371032 | 0;
    this.B = 914150663 | 0;
...
const utils = {
  ...
  randomBytes: (bytesLength = 32) => {
    if (crypto$1.web) {
      ...
      const { randomBytes: randomBytes2 } = crypto$1.node;
...
utils.hmacSha256Sync = (key, ...msgs) => {
  const h2 = hmac$3.create(sha256$2, key);
...
function hmacSha256(key, content) {
  return hmac$3(sha256$2, key, content);
}
...
var cryptoClients = {};
var secp256k1 = {};
let HMAC$1 = class HMAC2 extends Hash$2 {
  constructor(hash2, _key) {
    super();
    this.finished = false;
    this.destroyed = false;
...
class RIPEMD1602 extends SHA23 {
  constructor() {
    super(64, 20, 8, true);
    this.h0 = 1732584193 | 0;
    this.h1 = 4023233417 | 0;
...
const sha256 = wrapConstructor(() => new SHA2563());
wrapConstructor(() => new SHA2243());
...
const hmac = (hash2, key, message) => new HMAC3(hash2, key).update(message).digest();
    ...
    switch (bundleId) {
      case "connect-modal":
        return __vitePreload(() => import(
          /* webpackMode: "lazy" */
          "./connect-modal.entry.24f99e3e.js"
...
export {
  commonjsGlobal as A,
  savePaymentRequest as B,
  CONFIG as C,
  _regeneratorRuntime as D,
  _extends as E,
  getUserSession as F,
  getStacksProvider as G,
  lib as H,
  _objectWithoutPropertiesLoose as I,
  hasAppPrivateKey as J,
  getKeys as K,
  ...
  sha256$3 as Q,
  wrapConstructor$2 as R,
  StacksTestnet as S,
  SHA2$2 as T,
  registerInstance as U,
  h as V,
  getElement as W,
  ...
  bufferCVFromString as h,
  fetchSbtcEvents as i,
  fetchMyWrapTransactions as j,
  hexToBytes$1 as k,
  logUserOut as l,
  sendRawTxDirectMempool as m,
  utils as n,
  ...
  userSession as u,
  fetchUtxoSet as v,
  fetchTransaction as w,
  fetchCurrentFeeRates as x,
  decodeStacksAddress as y,
  signMessage as z
};
