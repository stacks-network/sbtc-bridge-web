import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, G as validate_store, H as component_subscribe, v as validate_slots, c as space, p as element, y as text, f as claim_space, q as claim_element, r as children, z as claim_text, l as detach_dev, x as add_location, g as insert_hydration_dev, J as append_hydration_dev, A as set_data_dev, I as noop, u as attr_dev } from './index.3d25d054.js';
import { s as sbtcConfig } from './stores.3318b909.js';
import { f as fmtSatoshiToBitcoin } from './utils.7513f4f0.js';

/* src/lib/components/common/UserBalance.svelte generated by Svelte v3.57.0 */
...
function create_fragment(ctx) {
	...
	let span;
	let t1;
	let t2_value = fmtSatoshiToBitcoin(/*$sbtcConfig*/ ctx[1]?.balance?.balance || 0) + "";
	let t2;
	let t3;
	...
	const block = {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*$sbtcConfig*/ 2 && t2_value !== (t2_value = fmtSatoshiToBitcoin(/*$sbtcConfig*/ ctx[1]?.balance?.balance || 0) + "")) set_data_dev(t2, t2_value);
		},
		i: noop,
		o: noop,
		d: function destroy(detaching) {
