...
import { d as fetchUserSbtcBalance } from "./bridge_api.0c8320ca.js";
import { _ as __vitePreload } from "./preload-helper.6910039e.js";
let lib, _objectWithoutPropertiesLoose, hasAppPrivateKey, getKeys, commonjsGlobal, getDefaultExportFromCjs, hexToBytes$1, registerInstance, h, getElement, PostConditionMode, StacksTestnet, _asyncToGenerator, addresses, loginStacksJs, base64Js, isLoggedIn, bufferCVFromString, utils, getStacksNetwork, getPublicKey$1, initSession, schnorr, hashMessage, logUserOut, bytesToHex$1, signMessage, openContractCall, principalCV, decodeStacksAddress, recoverPublicKey, stringAsciiCV, tupleCV, uintCV, verifyMessageSignature, _regeneratorRuntime, _extends, getUserSession, getStacksProvider;
let __tla = (async () => {
  commonjsGlobal = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {};
  getDefaultExportFromCjs = function getDefaultExportFromCjs2(x) {
  ...
  const cryptoBrowser = Object.freeze(Object.defineProperty({
    __proto__: null,
    crypto: crypto$2
  }, Symbol.toStringTag, {
    value: "Module"
  }));
  const require$$0$2 = getAugmentedNamespace(cryptoBrowser);
  (function(exports) {
    ...
    const hexes2 = Array.from({
      length: 256
    }, (v, i2) => i2.toString(16).padStart(2, "0"));
  ...
  (function(exports) {
    ...
    function c32encode(inputHex, minLength) {
      ...
      let res = [];
      let carry = 0;
      for (let i2 = inputHex.length - 1; i2 >= 0; i2--) {
        if (carry < 4) {
          const currentCode = hex.indexOf(inputHex[i2]) >> carry;
          let nextCode = 0;
          if (i2 !== 0) {
            nextCode = hex.indexOf(inputHex[i2 - 1]);
          }
      ...
      for (let i2 = 0; i2 < numLeadingZeroBytesInHex; i2++) {
    ...
    function c32decode(c32input, minLength) {
      ...
      let carry = 0;
      let carryBits = 0;
      for (let i2 = c32input.length - 1; i2 >= 0; i2--) {
        if (carryBits === 4) {
          res.unshift(hex[carry]);
          carryBits = 0;
          carry = 0;
        }
        const currentCode = exports.c32.indexOf(c32input[i2]) << carryBits;
      ...
      let hexStr = res.join("");
      for (let i2 = 0; i2 < numLeadingZeroBytes; i2++) {
        hexStr = `00${hexStr}`;
      }
      if (minLength) {
  ...
  const sha256$2 = Object.freeze(Object.defineProperty({
    __proto__: null,
    sha224,
    sha256: sha256$1
  }, Symbol.toStringTag, {
  ...
  const require$$0$1 = getAugmentedNamespace(sha256$2);
  ...
  var src = base;
  Object.defineProperty(base58check, "__esModule", {
    value: true
  });
  ...
  function encode$2(data, prefix = "00") {
    ...
    const checksum2 = (0, sha256_1$4.sha256)((0, sha256_1$4.sha256)(new Uint8Array([
      ...prefixBytes,
      ...dataBytes
    ])));
    return basex$1(ALPHABET$1).encode([
      ...prefixBytes,
      ...dataBytes,
      ...checksum2.slice(0, 4)
    ]);
  }
  base58check.encode = encode$2;
...
${bugDetails}`;
  ...
  bytesToHex$1 = function bytesToHex$12(uint8a) {
    if (!(uint8a instanceof Uint8Array))
      throw new Error("Uint8Array expected");
    let hex = "";
  ...
  hexToBytes$1 = function hexToBytes$12(hex) {
    if (typeof hex !== "string") {
      throw new TypeError(`hexToBytes: expected string, got ${typeof hex}`);
    }
  ...
  StacksTestnet = class StacksTestnet extends StacksNetwork {
    constructor(opts) {
      super({
  ...
  class AppConfig {
    constructor(scopes = DEFAULT_SCOPE.slice(), appDomain = ((_a) => (_a = getGlobalObject("location", {
      returnEmptyObject: true
    })) == null ? void 0 : _a.origin)(), redirectPath = "", manifestPath = "/manifest.json", coreNode = void 0, authenticatorURL = DEFAULT_BLOCKSTACK_HOST) {
  ...
  const hmac$1 = Object.freeze(Object.defineProperty({
    __proto__: null,
    hmac
  }, Symbol.toStringTag, {
    value: "Module"
  ...
  const nodeCrypto = Object.freeze(Object.defineProperty({
    __proto__: null,
  ...
  getPublicKey$1 = function getPublicKey$12(privateKey, isCompressed2 = false) {
    return Point.fromPrivateKey(privateKey).toRawBytes(isCompressed2);
  };
  recoverPublicKey = function recoverPublicKey2(msgHash, signature, recovery, isCompressed2 = false) {
  ...
  const shiftsL = idxL.map((idx, i2) => idx.map((j) => shifts[i2][j]));
  const shiftsR = idxR.map((idx, i2) => idx.map((j) => shifts[i2][j]));
  ...
  function base58CheckEncode(version2, hash2) {
    return base58Encode(concatBytes$1(new Uint8Array([
      version2
    ]), hash2.slice(0, 20)));
  }
  ...
  function encode$1(number2, bytes2, offset = 0) {
  ...
  const chainPrefix = "Stacks Signed Message:\n";
  hashMessage = function hashMessage2(message, prefix = chainPrefix) {
    return sha256$1(encodeMessage(message, prefix));
  };
  function encodeMessage(message, prefix = chainPrefix) {
    const messageBytes = typeof message == "string" ? utf8ToBytes(message) : message;
    const encodedLength = encode$1(messageBytes.length);
    return concatBytes$1(utf8ToBytes(prefix), encodedLength, messageBytes);
  }
  utils.hmacSha256Sync = (key, ...msgs) => {
    const h2 = hmac.create(sha256$1, key);
    msgs.forEach((msg) => h2.update(msg));
  ...
  verifyMessageSignature = function verifyMessageSignature2({ signature, message, publicKey }) {
    ...
    const verificationResult = verify$1(sig, hashedMsg, publicKey, {
      strict: false
    });
    if (verificationResult || typeof message !== "string")
      return verificationResult;
    const LEGACY_PREFIX = "Stacks Message Signing:\n";
    const legacyHash = sha256$1(encodeMessage(message, LEGACY_PREFIX));
    return verify$1(sig, legacyHash, publicKey, {
      strict: false
    });
  };
  ...
  var signer = {};
  var base64Url = {};
  Object.defineProperty(base64Url, "__esModule", {
    value: true
  });
  ...
  var cryptoClients = {};
  var secp256k1 = {};
  const require$$0 = getAugmentedNamespace(hmac$1);
  const require$$2 = getAugmentedNamespace(esm);
  var ecdsaSigFormatter = {};
  Object.defineProperty(ecdsaSigFormatter, "__esModule", {
    value: true
  });
  ...
  Object.defineProperty(secp256k1, "__esModule", {
    value: true
  });
  ...
  var sha256 = {};
  const require$$1 = getAugmentedNamespace(nodeCrypto);
  ...
  class TokenSigner {
    ...
    createWithSignedHash(payload, expanded, header, signingInput, signingInputHash) {
      ...
      if (expanded) {
        const signedToken = {
          header: [
            base64url$2.encode(JSON.stringify(header))
          ],
  ...
  class TokenVerifier {
    ...
    verifyExpanded(token, async) {
      const signingInput = [
        token["header"].join("."),
        base64url$1.encode(token["payload"])
      ].join(".");
      let verified = true;
      const performVerify = (signingInputHash) => {
  ...
  principalCV = function principalCV2(principal) {
  ...
  bufferCVFromString = (str) => bufferCV(utf8ToBytes(str));
  function noneCV() {
    return {
  ...
  tupleCV = function tupleCV2(data) {
  ...
  function deserializePublicKey(bytesReader) {
    ...
    return publicKeyFromBytes(concatArray([
      fieldId,
  ...
  function deserializePayload(bytesReader) {
    ...
    switch (payloadType) {
      ...
      case PayloadType.ContractCall:
        ...
        for (let i2 = 0; i2 < numberOfArgs; i2++) {
  ...
  function addressFromPublicKeys(version2, hashMode, numSigs, publicKeys) {
    ...
    if (hashMode === AddressHashMode.SerializeP2WPKH || hashMode === AddressHashMode.SerializeP2WSH) {
      for (let i2 = 0; i2 < publicKeys.length; i2++) {
        if (!isCompressed(publicKeys[i2])) {
  ...
  function serializeStringCV(cv, encoding2) {
    const bytesArray = [];
    const str = encoding2 == "ascii" ? asciiToBytes(cv.data) : utf8ToBytes(cv.data);
    const len2 = new Uint8Array(4);
    writeUInt32BE(len2, str.length, 0);
    bytesArray.push(len2);
    bytesArray.push(str);
    return bytesWithTypeID(cv.type, concatArray(bytesArray));
  }
  ...
  function deserializeCV(serializedClarityValue) {
    ...
    switch (type) {
      ...
      case ClarityType.Tuple:
        ...
        const tupleContents = {};
        for (let i2 = 0; i2 < tupleLength; i2++) {
  ...
  const hashP2WPKH = (input) => {
    ...
    const redeemScript = concatBytes$1(new Uint8Array([
      0
    ]), new Uint8Array([
      keyHash.length
    ]), keyHash);
  ...
  function createSingleSigSpendingCondition(hashMode, pubKey, nonce, fee) {
    const signer2 = addressFromPublicKeys(0, hashMode, 1, [
  ...
  function makeSigHashPreSign(curSigHash, authType, fee, nonce) {
    ...
    const sigHash = curSigHash + bytesToHex$1(new Uint8Array([
      authType
    ])) + bytesToHex$1(intToBytes(fee, false, 8)) + bytesToHex$1(intToBytes(nonce, false, 8));
  ...
  function verifySingleSig(condition, initialSigHash, authType) {
    ...
    const addrBytes = addressFromPublicKeys(0, condition.hashMode, 1, [
      pubKey
    ]).hash160;
  ...
  getStacksProvider = function getStacksProvider2() {
  ...
  _asyncToGenerator = function _asyncToGenerator2(fn) {
    return function() {
  ...
  _objectWithoutPropertiesLoose = function _objectWithoutPropertiesLoose2(source, excluded) {
    if (source == null)
      return {};
    var target = {};
  ...
  var authenticate = function() {
    var _ref = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(authOptions) {
  ...
  getUserSession = function getUserSession2(_userSession) {
  ...
  hasAppPrivateKey = function hasAppPrivateKey2(userSession2) {
    try {
  ...
  getKeys = function getKeys2(_userSession) {
  ...
  function _signPayload$1() {
    _signPayload$1 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee5(payload, privateKey) {
  ...
  var openTransactionPopup = function() {
  ...
  var makeContractCallToken = function() {
    var _ref3 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee2(options) {
  ...
  function _generateTokenAndOpenPopup$1() {
    _generateTokenAndOpenPopup$1 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee6(options, makeTokenFn) {
      var token;
  ...
  openContractCall = function openContractCall2(options) {
  ...
  function _signPayload() {
    _signPayload = _asyncToGenerator(_regeneratorRuntime().mark(function _callee2(payload, privateKey) {
      var tokenSigner;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1)
          switch (_context2.prev = _context2.next) {
  ...
  function _openSignaturePopup() {
    _openSignaturePopup = _asyncToGenerator(_regeneratorRuntime().mark(function _callee3(_ref) {
  ...
  var signMessage$1 = function() {
    var _ref2 = _asyncToGenerator(_regeneratorRuntime().mark(function _callee(options) {
  ...
  function _generateTokenAndOpenPopup() {
    _generateTokenAndOpenPopup = _asyncToGenerator(_regeneratorRuntime().mark(function _callee4(options, makeTokenFn) {
      var token;
  ...
  const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
    ...
    if (!hmrVersionId || !BUILD.hotModuleReplacement) {
      ...
      switch (bundleId) {
        case "connect-modal":
          return __vitePreload(() => import("./connect-modal.entry.b80a09da.js"), true ? [] : void 0, import.meta.url).then(processMod, consoleError);
      }
    }
    return __vitePreload(() => import(`./${bundleId}.entry.js${""}`).then(async (m) => {
      await m.__tla;
      return m;
  ...
  let userSession;
  initSession = function initSession2() {
    userSession = new UserSession({
      appConfig
    });
  };
  getStacksNetwork = function getStacksNetwork2() {
    let stxNetwork;
    stxNetwork = new StacksMainnet();
    return stxNetwork;
  };
  decodeStacksAddress = function decodeStacksAddress2(stxAddress) {
    if (!stxAddress)
  ...
  loginStacksJs = async function loginStacksJs2() {
    try {
  ...
  isLoggedIn = function isLoggedIn2() {
    return userSession.isUserSignedIn();
  };
  logUserOut = function logUserOut2() {
    return userSession.signUserOut();
  };
  signMessage = function signMessage2(callback, script) {
...
export {
  ...
  hasAppPrivateKey as C,
  getKeys as D,
  commonjsGlobal as E,
  getDefaultExportFromCjs as F,
  hexToBytes$1 as G,
  registerInstance as H,
  h as I,
  getElement as J,
  ...
  principalCV as p,
  decodeStacksAddress as q,
  recoverPublicKey as r,
  stringAsciiCV as s,
  tupleCV as t,
  uintCV as u,
  verifyMessageSignature as v,
  _regeneratorRuntime as w,
  _extends as x,
  getUserSession as y,
  getStacksProvider as z
};
