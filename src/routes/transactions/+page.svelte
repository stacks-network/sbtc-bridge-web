                ...
                <div class="table-auto">
                    ...
                    <div class="w-full grid grid-cols-4 lg:grid-cols-6 gap-2 justify-evenly content-start">
                        ...
                        <div class="flex">
                            ...
                            <div class=""><LinkToExplorer class="-mr-0.5 h-4 w-4 text-white" target={explorerBtcAddressUrl(pegin.fromBtcAddress)} /></div>
                        </div>
                        <div class="hidden lg:flex ">
                            ...
                            <div class=""><LinkToExplorer class="-mr-0.5 h-4 w-4 text-white" target={explorerBtcAddressUrl(getTo(pegin))} /></div>
                        ...
                        <div class="flex">
                            ...
                            <div class="text-right">
                                {#if pegin.status > 1}
                                <LinkToExplorer class="-mr-0.5 h-4 w-4 text-white" target={explorerBtcTxUrl(pegin.btcTxid)} />
                                {/if}
                            </div>
                        </div>
