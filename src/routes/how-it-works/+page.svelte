...
<div class="py-6 mx-auto max-w-7xl md:px-6">
  <div class="flex flex-col w-full my-8">
    <div class="flex flex-col w-full border-[0.5px] border-gray-700 rounded-lg p-10 overflow-hidden bg-gray-1000">
			...
			<div class="space-y-8">
				...
				<div class="p-[1.2px] bg-[linear-gradient(126.12deg,rgba(237,105,60,0.5)11.8%,rgba(254,219,99,0.2)72.43%)] rounded-lg">
					...
					>
						<div class="sm:flex sm:items-center gap-x-10">
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" class="h-auto w-44 shrink-0" viewBox="0 0 208 204">
							...
							<div class="w-full sm:w-3/5">
								<h2 class="text-3xl font-bold">sBTC Bridge</h2>
				...
				<div class="bg-[linear-gradient(180deg,#A9E6D2_0%,rgba(169,230,210,0.00)100%)] p-[1.2px] rounded-lg">
					<div class="relative flex items-center justify-between gap-10 px-10 py-6 rounded-lg bg-black-01">
						<div>
						...
						<div class="flex items-center gap-4">
							...
							<a href="https://www.xverse.app/download" class="border-gray-900 border hover:border-gray-600 transition duration-1000 ease-in-out rounded-md px-12 py-4 bg-[linear-gradient(126deg,#121212_43.38%,#404040_81.42%,#EE7A30_94.1%)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/50">
								<svg class="w-32 h-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 16" fill="none">
				...
				<div class="sm:grid sm:grid-cols-2 sm:gap-6 sm:space-y-0">
					<div class="space-y-6 px-10 space-y-8 divide-y divide-gray-400/30 py-6 bg-white/5 rounded-lg border border-primary-500/20 shadow-[0px_1px_6px_0px_rgba(254,219,99,0.20)]">
						<div>
					...
					<div class="space-y-6 px-10 space-y-8 divide-y divide-gray-400/30 py-6 bg-white/5 rounded-lg border border-blue-500/20 shadow-[0px_1px_6px_0px_rgba(173,188,246,0.20)]">
						<div>
							<div class="flex items-start justify-between gap-4">
							...
							<h3 class="text-2xl font-bold">Withdraw BTC, burn sBTC</h3>
						</div>
						<div>
