  ...
  function create_fragment$3(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        attr_dev(a3, "href", base + "/");
        add_location(a3, file$3, 51, 10, 2242);
        add_location(li2, file$3, 51, 6, 2238);
