...
import { c as cr, u as ur, H as Hr, m as m$2, R as Rr, _ as _$2, g as ge$2, $ as $$2, q as q$1, h as hr, U as Ur, V as Vt, p as p$4, a as $$3, b as utils, d as getPublicKey, w as wt, E as Er, e as pe, f as f$3, i as U$2, r as recoverPublicKey, S as Signature, j as d$2, k as Se, A as At, l as pe$1, n as S$1, K as K$1, o as lr, s as ut$1, t as ct$1, v as mt, x as ee$2, y as qe$1, z as verify, B as ar, C as Kt, D as ce$2, F as Rr$1, I as Ir, G as pr, J as pr$1, L as dr, M as xr, N as we$1, O as V$1, P as l$3, X as X$1, Q as Xt, T as sbtcConfig, W as fetchSbtcWalletAddress, Y as ArrowUp, Z as ArrowDown, a0 as fetchFeeEstimate } from "../../chunks/utxos-1715004d.js";
let Layout;
let __tla = (async () => {
  const app = "";
  ...
  var h$4 = (e, t, r) => pe$1({
    ...
    var o;
    let t = typeof e.message != "string" ? Vt(e.message) : e.message, r = h$4(e.domain.name, e.domain.version, e.domain.chainId ?? ((o = e.network) == null ? void 0 : o.chainId) ?? ur.Mainnet), n = Vt(r), s = {
      stxAddress: e.stxAddress,
      message: Ur(t),
      domain: Ur(n),
      appDetails: e.appDetails,
...
`, I$2 = utils.utf8ToBytes(We$1);
  ...
  var Q$1 = ({ hash: e, signature: t, recoveryBytes: r }) => recoverPublicKey(e, t, Number(r), true), Z$2 = (e) => {
    ...
    try {
      let s = typeof t == "string" ? R$2(t, e.prefix) : t, { signature: o, recoveryBytes: a2 } = Z$2({
...
`);
    for (let t of e) {
      if (!t || !t.trim())
        continue;
      let s = t.toUpperCase();
      /\s+TXT\s+/.test(s) ? (n.txt = n.txt || [], n.txt.push(h$3(t))) : s.indexOf("$ORIGIN") === 0 ? n.$origin = t.split(/\s+/g)[1] : s.indexOf("$TTL") === 0 ? n.$ttl = parseInt(t.split(/\s+/g)[1], 10) : /\s+SOA\s+/.test(s) ? n.soa = l(t) : /\s+NS\s+/.test(s) ? (n.ns = n.ns || [], n.ns.push(g(t))) : /\s+A\s+/.test(s) ? (n.a = n.a || [], n.a.push(T$1(t, n.a))) : /\s+AAAA\s+/.test(s) ? (n.aaaa = n.aaaa || [], n.aaaa.push(m$1(t))) : /\s+CNAME\s+/.test(s) ? (n.cname = n.cname || [], n.cname.push(y$3(t))) : /\s+MX\s+/.test(s) ? (n.mx = n.mx || [], n.mx.push(N$2(t))) : /\s+PTR\s+/.test(s) ? (n.ptr = n.ptr || [], n.ptr.push(d(t, n.ptr, n.$origin))) : /\s+SRV\s+/.test(s) ? (n.srv = n.srv || [], n.srv.push(I$1(t))) : /\s+SPF\s+/.test(s) ? (n.spf = n.spf || [], n.spf.push(A$2(t))) : /\s+URI\s+/.test(s) && (n.uri = n.uri || [], n.uri.push(R$1(t)));
    }
    return n;
  }
  function l(r) {
  ...
  function M$1(r) {
    let { hubInfo: e, privateKey: t, gaiaHubUrl: o, associationToken: n = null, scopes: s } = r, { challenge_text: i2 } = e, a2 = p$4(getPublicKey(t, true)), u2 = $$3(16).toString();
    return {
      gaiaChallenge: i2,
      hubUrl: o,
      iss: a2,
...
${o}`, this.message = t, this.code = e.code, this.parameter = e.parameter ? e.parameter : void 0;
  ...
  function _e(r, e) {
    ...
    let n = o.issuer.publicKey, s = qe$1(n);
    if (e !== n) {
      if (e !== s)
  ...
  async function ne(r, e) {
    let { app: t, username: o, zoneFileLookupURL: n, gaiaHubConfig: s } = e, i2 = `${r}${h$2}`;
    try {
...
`);
  ...
  function instance$4($$self, $$props, $$invalidate) {
    ...
    $$self.$capture_state = () => ({
      ...
      logout,
      doLogin,
      webWalletNeeded: webWalletNeeded2,
      $auth
    });
    $$self.$inject_state = ($$props2) => {
      if ("webWalletNeeded" in $$props2)
        $$invalidate(4, webWalletNeeded2 = $$props2.webWalletNeeded);
    };
  ...
  function create_if_block$1(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(40:215) {#if $sbtcConfig.pegIn}",
      ctx
    });
    return block;
  }
  function create_fragment$3(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(img, file$3, 30, 4, 1149);
        attr_dev(a0, "class", "navbar-brand");
        attr_dev(a0, "href", "/");
        add_location(a0, file$3, 29, 5, 1111);
        attr_dev(span0, "class", "navbar-toggler-icon");
        add_location(span0, file$3, 33, 4, 1405);
        ...
        add_location(button, file$3, 32, 3, 1222);
        attr_dev(a1, "class", "text-white");
        attr_dev(a1, "href", "/");
        add_location(a1, file$3, 39, 140, 1761);
        ...
        add_location(span1, file$3, 39, 7, 1628);
        attr_dev(span2, "class", "pointer nav-link");
        add_location(span2, file$3, 38, 6, 1589);
        attr_dev(li0, "class", "nav-item");
        add_location(li0, file$3, 37, 5, 1561);
        ...
        add_location(span3, file$3, 43, 6, 2068);
        attr_dev(a2, "class", "dropdown-item");
        attr_dev(a2, "href", "/");
        add_location(a2, file$3, 47, 12, 2341);
        add_location(li1, file$3, 47, 8, 2337);
        attr_dev(a3, "class", "dropdown-item");
        attr_dev(a3, "href", "/");
        add_location(a3, file$3, 48, 12, 2461);
        add_location(li2, file$3, 48, 8, 2457);
        attr_dev(ul0, "class", "dropdown-menu dropdown-menu-start");
        attr_dev(ul0, "aria-labelledby", "navbarDropdown");
        add_location(ul0, file$3, 46, 6, 2249);
        attr_dev(li3, "class", "nav-item dropdown");
        add_location(li3, file$3, 42, 5, 2031);
        attr_dev(li4, "class", "nav-item mb-1");
        add_location(li4, file$3, 51, 5, 2597);
        attr_dev(ul1, "class", "navbar-nav text-white");
        add_location(ul1, file$3, 36, 4, 1521);
        attr_dev(div0, "class", "collapse navbar-collapse");
        attr_dev(div0, "id", "navbarNav");
        add_location(div0, file$3, 35, 3, 1463);
        attr_dev(div1, "class", "container-fluid mx-5");
        add_location(div1, file$3, 28, 2, 1071);
        attr_dev(nav, "class", "navbar navbar-expand-md transparent");
        add_location(nav, file$3, 27, 1, 1019);
      },
      m: function mount(target, anchor) {
  ...
  function create_else_block(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        add_location(p0, file, 81, 2, 2738);
        if (!src_url_equal(img.src, img_src_value = stx_eco_wallet_off))
          attr_dev(img, "src", img_src_value);
        attr_dev(img, "alt", "Connect Wallet / Login");
        attr_dev(img, "width", "40");
        attr_dev(img, "height", "auto");
        add_location(img, file, 82, 116, 2891);
        attr_dev(span0, "class", "px-1");
        add_location(span0, file, 82, 96, 2871);
        attr_dev(a2, "href", "/");
        attr_dev(a2, "class", "pointer px-2");
        add_location(a2, file, 82, 28, 2803);
        attr_dev(span1, "class", "nav-item");
        add_location(span1, file, 82, 5, 2780);
        add_location(p1, file, 82, 2, 2777);
        attr_dev(div, "class", "lobby bg-dark s-7IPF32Wcq3s8");
        add_location(div, file, 80, 0, 2708);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(div, file, 72, 0, 2575);
      },
      m: function mount(target, anchor) {
        insert_hydration_dev(target, div, anchor);
