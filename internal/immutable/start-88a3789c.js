import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, a as afterUpdate, o as onMount, b as setContext, c as space, e as empty, f as claim_space, g as insert_hydration_dev, h as group_outros, t as transition_out, j as check_outros, k as transition_in, l as detach_dev, m as construct_svelte_component_dev, n as element, p as claim_element, q as children, r as attr_dev, u as set_style, w as add_location, x as text, y as claim_text, z as set_data_dev, A as create_component, B as claim_component, C as mount_component, D as destroy_component, E as tick } from "./chunks/index-2f10db54.js";
import { S as SCROLL_KEY, I as INDEX_KEY, g as get_base_uri, f as find_anchor, a as get_link_info, b as get_router_options, s as stores, i as is_external_url, c as scroll_state, P as PRELOAD_PRIORITIES, d as init$1 } from "./chunks/singletons-cfe4d95f.js";
...
let __tla = (async () => {
  ...
  }
  {
    ...
    window.fetch = (input, init2) => {
      ...
      const stack = stack_array.slice(0, firefox_cutoff !== -1 ? firefox_cutoff : void 0).join("\n");
      const heuristic = can_inspect_stack_trace ? stack.includes("src/runtime/client/client.js") : loading;
      if (heuristic) {
        console.warn(`Loading ${url} using \`window.fetch\`. For best results, use the \`fetch\` that is passed to your \`load\` function: https://kit.svelte.dev/docs/load#making-fetch-requests`);
      }
    ...
    if (cache.size > 0) {
      ...
      if (cached) {
        if (performance.now() < cached.ttl && [
          ...
          "only-if-cached",
          void 0
        ].includes(opts == null ? void 0 : opts.cache)) {
  ...
  function parse_route_id(id) {
    const params = [];
    const pattern = id === "/" ? /^\/$/ : new RegExp(`^${get_route_segments(id).map((segment) => {
      ...
      const result = parts.map((content, i) => {
        if (i % 2) {
          ...
          if (content.startsWith("u+")) {
            return escape(String.fromCharCode(...content.slice(2).split("-").map((code) => parseInt(code, 16))));
          }
          const match = param_pattern.exec(content);
          if (!match) {
            throw new Error(`Invalid param: ${content}. Params and matcher names can only have underscores and alphanumeric characters.`);
          }
  ...
  function parse(nodes2, server_loads2, dictionary2, matchers2) {
    ...
    function create_layout_loader(id) {
      return id === void 0 ? id : [
        layouts_with_server_load.has(id),
        nodes2[id]
      ];
    }
  }
  ...
  function create_default_slot(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "slot",
      source: "(40:1) <svelte:component this={components[0]} data={data_0}>",
      ctx
    });
    return block;
  }
  function create_if_block(ctx) {
    ...
    const block = {
      ...
      h: function hydrate() {
        ...
        add_location(div, file, 47, 1, 993);
      },
      m: function mount(target, anchor) {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    $$self.$$.on_mount.push(function() {
      if (stores2 === void 0 && !("stores" in $$props || $$self.$$.bound[$$self.$$.props["stores"]])) {
    ...
    $$self.$inject_state = ($$props2) => {
      ...
      if ("navigated" in $$props2)
        $$invalidate(5, navigated = $$props2.navigated);
      if ("title" in $$props2)
  ...
  const matchers = {};
  const nodes = [
    () => __vitePreload(() => import("./chunks/0-a9c298f4.js"), true ? ["./chunks/0-a9c298f4.js","./components/pages/_layout.svelte-5fcdcca5.js","./chunks/preload-helper-bd152303.js","./chunks/index-2f10db54.js","./chunks/stores-96fe850b.js","./chunks/stacks-71c6e6ab.js","./chunks/sbtc_admin-d603c98c.js","./chunks/index-3d62e9f1.js","./assets/_layout-0db01315.css"] : void 0, import.meta.url),
    () => __vitePreload(() => import("./chunks/1-2116c6b0.js"), true ? ["./chunks/1-2116c6b0.js","./components/error.svelte-6064a841.js","./chunks/index-2f10db54.js","./chunks/singletons-cfe4d95f.js"] : void 0, import.meta.url),
    () => __vitePreload(() => import("./chunks/2-4cc31fb4.js"), true ? ["./chunks/2-4cc31fb4.js","./chunks/_page-ff02d51a.js","./components/pages/_page.svelte-ed8cde2a.js","./chunks/index-2f10db54.js","./chunks/stores-96fe850b.js","./chunks/stacks-71c6e6ab.js","./chunks/UserBalance-bf786f0c.js","./chunks/index-3d62e9f1.js","./chunks/bootstrap.esm-e88d1e6f.js","./assets/_page-5e5380ae.css"] : void 0, import.meta.url),
    () => __vitePreload(() => import("./chunks/3-0eef27dd.js"), true ? ["./chunks/3-0eef27dd.js","./components/pages/admin/_page.svelte-f827608b.js","./chunks/index-2f10db54.js","./chunks/sbtc_admin-d603c98c.js","./chunks/stores-96fe850b.js","./assets/_page-4b9f9046.css"] : void 0, import.meta.url),
    () => __vitePreload(() => import("./chunks/4-d49ef51d.js"), true ? ["./chunks/4-d49ef51d.js","./components/pages/history/_page.svelte-46fece7d.js","./chunks/index-2f10db54.js","./chunks/stores-96fe850b.js","./chunks/UserBalance-bf786f0c.js","./chunks/stacks-71c6e6ab.js","./assets/_page-478e00e9.css"] : void 0, import.meta.url)
  ];
  const server_loads = [];
  const dictionary = {
    "/": [
  ...
  async function unwrap_promises(object) {
    ...
    for (const key in object) {
      if (typeof ((_a = object[key]) == null ? void 0 : _a.then) === "function") {
        return Object.fromEntries(await Promise.all(Object.entries(object).map(async ([key2, value]) => [
          key2,
          await value
        ])));
      }
    ...
    function validate(module, route_id) {
      ...
      for (const key in module) {
        if (key[0] !== "_" && !set.has(key)) {
          ...
          throw new Error(`Invalid export '${key}'${route_id ? ` in ${route_id}` : ""} (valid exports are ${valid}, or anything with a '_' prefix)`);
        }
      }
    }
    return validate;
  ...
  function create_client({ target, base }) {
    ...
    async function goto(url, { noScroll = false, replaceState = false, keepFocus = false, state = {}, invalidateAll = false }, redirect_chain, nav_token) {
    ...
    async function preload_code(...pathnames) {
      ...
      const promises = matching.map((r) => {
        return Promise.all([
          ...r.layouts,
          r.leaf
        ].map((load) => load == null ? void 0 : load[1]()));
      });
    ...
    async function update(intent, url, redirect_chain, opts, nav_token = {}, callback) {
      ...
      if (!navigation_result) {
        navigation_result = await server_fallback(url, {
          id: null
    ...
    function initialize(result) {
      ...
      const navigation = {
        ...
        to: {
          ...
          route: {
            id: ((_a2 = current.route) == null ? void 0 : _a2.id) ?? null
          },
    ...
    async function get_navigation_result_from_branch({ url, params, branch, status, error, route, form }) {
    ...
    async function load_node({ loader, parent, url, params, route, server_data_node }) {
        ...
        };
        {
          try {
            ...
            if (data != null && Object.getPrototypeOf(data) !== Object.prototype) {
              throw new Error(`a load function related to route '${route.id}' returned ${typeof data !== "object" ? `a ${typeof data}` : data instanceof Response ? "a Response object" : Array.isArray(data) ? "an array" : "a non-plain object"}, but must return a plain object at the top level (i.e. \`return {...}\`)`);
            }
          } finally {
            unlock_fetch();
          }
      ...
      return {
        ...
        universal: ((_b = node.universal) == null ? void 0 : _b.load) ? {
          type: "data",
          data,
          uses
        } : null,
    ...
    async function load_route({ id, invalidating, url, params, route }) {
      ...
      const invalid_server_nodes = loaders.reduce((acc, loader, i) => {
        ...
        const invalid = !!(loader == null ? void 0 : loader[0]) && ((previous == null ? void 0 : previous.loader) !== loader[1] || has_changed(acc.some(Boolean), route_changed, url_changed, (_a2 = previous.server) == null ? void 0 : _a2.uses, params));
        acc.push(invalid);
        return acc;
      }, []);
      ...
      const branch_promises = loaders.map(async (loader, i) => {
        ...
        return load_node({
          ...
          server_data_node: create_data_node(server_data_node === void 0 && loader[0] ? {
            type: "skip"
          } : server_data_node ?? null, previous == null ? void 0 : previous.server)
        });
      });
        ...
        if (loaders[i]) {
          try {
            ...
            if (error_load) {
              ...
              return await server_fallback(url, {
                id: route.id
              }, error, status);
            }
          }
    ...
    async function load_root_error_page({ status, error, url, route }) {
      ...
      if (node.has_server_load) {
        try {
          const server_data = await load_data(url, [
            true
          ]);
    ...
    function before_navigate({ url, type, intent, delta }) {
      ...
      const navigation = {
        ...
        to: {
          ...
          route: {
            id: ((_b = intent == null ? void 0 : intent.route) == null ? void 0 : _b.id) ?? null
          },
          url
        },
        willUnload: !intent,
    ...
    async function navigate({ url, scroll: scroll2, keepfocus, redirect_chain, details, type, delta, nav_token, accepted, blocked }) {
      const intent = get_navigation_intent(url, false);
      const navigation = before_navigate({
        url,
        type,
        delta,
        intent
      ...
      await update(intent, url, redirect_chain, {
        scroll: scroll2,
        keepfocus,
        details
      }, nav_token, () => {
    ...
    return {
          ...
          if (!navigating) {
            const navigation = {
              from: {
                params: current.params,
                route: {
                  id: ((_a3 = current.route) == null ? void 0 : _a3.id) ?? null
                },
                url: current.url
              },
              to: null,
      ...
      _hydrate: async ({ status = 200, error, node_ids, params, route, data: server_data_nodes, form }) => {
        hydrated = true;
        const url = new URL(location.href);
        {
          ({ params = {}, route = {
        ...
        try {
          ...
          result = await load_root_error_page({
            ...
            error: await handle_error(error2, {
              url,
              params,
              route
            }),
  ...
  async function load_data(url, invalid) {
    ...
    data_url.searchParams.append("x-sveltekit-invalidated", invalid.map((x) => x ? "1" : "").join("_"));
  ...
  }
  {
    ...
    console.warn = function warn(...args) {
      if (args.length === 1 && /<(Layout|Page)(_[\w$]+)?> was created (with unknown|without expected) prop '(data|form)'/.test(args[0])) {
        return;
      }
      console_warn(...args);
    };
  }
  start = async function start2({ env, hydrate, paths, target, version }) {
    set_paths(paths);
