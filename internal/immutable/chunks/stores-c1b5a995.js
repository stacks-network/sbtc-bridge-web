...
async function readEvents(network) {
  const path = network === "mainnet" ? "https://stacks-node-api.mainnet.stacks.co" : "http://localhost:3999";
  ...
  for (const event of val.results) {
    event.data = T$2(c$2(event.contract_log.value.hex));
  }
  return val.results;
}
...
async function callContractReadOnly(data) {
  ...
  const val = await response.json();
  const result = T$2(c$2(val.result));
  return result;
}
...
export { Ce as C, Ir as I, K$1 as K, Qt as Q, S$1 as S, __viteBrowserExternal$1 as _, a, se as b, c$1 as c, C as d, defaultSbtcConfig as e, fetchSbtcWalletAddress as f, sha256$1 as g, se$1 as h, i, ur as j, fetchUserBalance as k, he as l, pe as p, readEvents as r, sbtcConfig as s, utils$1 as u, ve$2 as v };
