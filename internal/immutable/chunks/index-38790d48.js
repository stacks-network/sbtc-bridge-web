...
async function attachTransaction(utxo) {
...
async function attachAllInputTransactions(utxos) {
...
async function fetchFeeEstimate() {
  try {
    ...
    console.log(err);
    return { low_fee_per_kb: 2e4, medium_fee_per_kb: 3e4, high_fee_per_kb: 4e4 };
  }
}
...
export { fetchAddressDetails as a, buffer as b, fetchUTXOs as c, attachAllInputTransactions as d, fetchFeeEstimate as f, isSupported as i, maxCommit as m };
