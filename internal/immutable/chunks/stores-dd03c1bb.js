import { P as setContext, Q as getContext, R as derived, T as readable, U as get_store_value, B as writable } from './index-963bdb90.js';
...
async function readEvents() {
  const path = "https://stacks-node-api.mainnet.stacks.co";
  const contractId = "SP000000000000000000002Q6VF78.sbtc-alpha";
  const url = path + "/extended/v1/contract/" + contractId + "/events";
  const response = await fetch(url);
  const val = await response.json();
  for (const event of val.results) {
    event.data = T$2(c$1(event.contract_log.value.hex));
  }
  return val.results;
}
async function fetchSbtcWalletAddress() {
  try {
    const contractId = "SP000000000000000000002Q6VF78.sbtc-alpha";
    const data = {
...
async function fetchUserBalance(stxAddress) {
  try {
    const contractId = "SP000000000000000000002Q6VF78.sbtc-alpha";
...
export { Ce as C, Ir as I, K$1 as K, S$1 as S, __viteBrowserExternal$1 as _, a, se as b, C as c, defaultSbtcConfig as d, sha256$1 as e, fetchSbtcWalletAddress as f, se$1 as g, ur as h, i, fetchUserBalance as j, he as k, pe as p, readEvents as r, sbtcConfig as s, utils$1 as u, ve$2 as v };
